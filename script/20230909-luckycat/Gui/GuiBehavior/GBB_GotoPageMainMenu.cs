...
namespace VLGameProject.VLGui {
    [CreateAssetMenu(fileName = "New GotoPageMainMenu", menuName = "VLGameProject/Gui/GuiBehaviorButton/GotoPageMainMenu")]
    public class GBB_GotoPageMainMenu : SOABSGuiButtonBehavior {
