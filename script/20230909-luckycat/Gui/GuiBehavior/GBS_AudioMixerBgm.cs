...
namespace VLGameProject.VLGui {
    [CreateAssetMenu(fileName = "New AudioMixerBgm", menuName = "VLGameProject/Gui/GuiBehaviorSlider/New AudioMixerBgm")]
    public class GBS_AudioMixerBgm : SOABSGuiSliderBehavior {
