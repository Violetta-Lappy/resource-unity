...
namespace VLGameProject.VLGui {
    [CreateAssetMenu(fileName = "New OptionBrightness", menuName = "VLGameProject/Gui/GuiBehaviorSlider/New OptionBrightness")]
    public class GBS_OptionBrightness : SOABSGuiSliderBehavior {
