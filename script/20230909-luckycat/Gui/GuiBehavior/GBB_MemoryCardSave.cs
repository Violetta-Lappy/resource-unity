...
namespace VLGameProject.VLGui {
    [CreateAssetMenu(fileName = "New MemoryCardSave", menuName = "VLGameProject/Gui/GuiBehaviorButton/MemoryCardSave")]
    public class GBB_MemoryCardSave : SOABSGuiButtonBehavior {
