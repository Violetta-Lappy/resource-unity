...
namespace VLGameProject.VLGui {
    [CreateAssetMenu(fileName = "New AskExitToMainMenu", menuName = "VLGameProject/Gui/GuiBehaviorButton/AskExitToMainMenu")]
    public class GBB_AskExitToMainMenu : SOABSGuiButtonBehavior {
        public override void GuiBehaviorButton_Init() {
            throw new System.NotImplementedException();
        }

        public override void GuiBehaviorButton_OnMouseDown() {
            //TODO - Add Logic that open Gui Page Asking to Exit to Main Menu 
        }
