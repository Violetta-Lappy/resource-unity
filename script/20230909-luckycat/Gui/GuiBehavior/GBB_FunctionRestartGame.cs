...
namespace VLGameProject.VLGui {
    [CreateAssetMenu(fileName = "New FunctionRestartGame", menuName = "VLGameProject/Gui/GuiBehaviorButton/FunctionRestartGame")]
    public class GBB_FunctionRestartGame : SOABSGuiButtonBehavior {
