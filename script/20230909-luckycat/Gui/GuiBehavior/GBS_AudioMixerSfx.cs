...
namespace VLGameProject.VLGui {
    [CreateAssetMenu(fileName = "New AudioMixerSfx", menuName = "VLGameProject/Gui/GuiBehaviorSlider/New AudioMixerSfx")]
    public class GBS_AudioMixerSfx : SOABSGuiSliderBehavior {
