...
namespace VLGameProject.VLGui {
    [CreateAssetMenu(fileName = "New TimeGameCountdown", menuName = "VLGameProject/Gui/GuiBehaviorText/New TimeGameCountdown")]
    public class GBT_TimeGameCountdown : SOABSGuiTextBehavior {
