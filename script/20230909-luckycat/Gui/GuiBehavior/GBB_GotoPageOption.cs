...
namespace VLGameProject.VLGui {
    [CreateAssetMenu(fileName = "New GotoPageOption", menuName = "VLGameProject/Gui/GuiBehaviorButton/GotoPageOption")]
    public class GBB_GotoPageOption : SOABSGuiButtonBehavior {
