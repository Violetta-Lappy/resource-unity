...
namespace VLGameProject.VLGui {
    [CreateAssetMenu(fileName = "New GotoPageLeaderboard", menuName = "VLGameProject/Gui/GuiBehaviorButton/GotoPageLeaderboard")]
    public class GBB_GotoPageLeaderboard : SOABSGuiButtonBehavior {
