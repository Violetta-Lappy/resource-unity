...
namespace VLGameProject.VLGui {
    [CreateAssetMenu(fileName = "New LocalizationSetVietnamese", menuName = "VLGameProject/Gui/GuiBehaviorButton/LocalizationSetVietnamese")]
    public class GBB_LocalizationSetVietnamese : SOABSGuiButtonBehavior {
