...
namespace VLGameProject.VLGui {
    [CreateAssetMenu(fileName = "New GotoPageOptionAudio", menuName = "VLGameProject/Gui/GuiBehaviorButton/GotoPageOptionAudio")]
    public class GBB_GotoPageOptionAudio : SOABSGuiButtonBehavior {
