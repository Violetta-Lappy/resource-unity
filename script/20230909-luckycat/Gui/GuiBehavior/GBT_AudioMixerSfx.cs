...
namespace VLGameProject.VLGui {
    [CreateAssetMenu(fileName = "New AudioMixerSfx", menuName = "VLGameProject/Gui/GuiBehaviorText/New AudioMixerSfx")]
    public class GBT_AudioMixerSfx : SOABSGuiTextBehavior {
