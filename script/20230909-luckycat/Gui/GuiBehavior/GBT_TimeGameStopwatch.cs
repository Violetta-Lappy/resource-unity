...
namespace VLGameProject.VLGui {
    [CreateAssetMenu(fileName = "New TimeGameStopwatch", menuName = "VLGameProject/Gui/GuiBehaviorText/New TimeGameStopwatch")]
    public class GBT_TimeGameStopwatch : SOABSGuiTextBehavior {
