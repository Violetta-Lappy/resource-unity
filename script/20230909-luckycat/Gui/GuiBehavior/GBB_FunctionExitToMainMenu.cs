...
namespace VLGameProject.VLGui {
    [CreateAssetMenu(fileName = "New FunctionExitToMainMenu", menuName = "VLGameProject/Gui/GuiBehaviorButton/FunctionExitToMainMenu")]
    public class GBB_FunctionExitToMainMenu : SOABSGuiButtonBehavior {
